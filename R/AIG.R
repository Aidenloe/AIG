...
#' @details The package will include several generators for psychological research purposes. Currently, it can only generate linear syllogism items.
#' @section Linear Syllogism Generation:
#' This function creates linear syllogsim items according to your specifications. \cr
#' \code{\link{lisy}}
#' @references
