...
## Installation
`AIG` will be [CRAN](http://cran.r-project.org/) soon, but you can use [devtools](http://cran.r-project.org/web/packages/devtools/index.html) to install the latest and greatest version2.
To do so:
