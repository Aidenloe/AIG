...
## Installation
`AIG` will be in [CRAN](http://cran.r-project.org/) soon, but you can use [devtools](https://cran.r-project.org/package=devtools) to install the latest and greatest version.
To do so:
